                        ...
                        <div className="project-card" key={project.id}>
                            <div className="project-thumbnail">
                                ...
                                {project.icon && (project.icon.startsWith("http") || project.icon.includes("/") || project.icon.startsWith("data:")) ? (
                                    <img src={project.icon} alt={`${project.title} icon`} style={{ width: 'auto', height: 'auto', maxWidth: '250px', maxHeight: '140px', objectFit: 'contain', zIndex: 1, position: 'relative', filter: 'drop-shadow(0 4px 20px rgba(0, 0, 0, 0.3))' }} />
                                ) : (
